...
<body data-spy="scroll" data-target=".navbar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <!-- <li><a href="http://codecanyon.net/item/instant-job-search-engine-aggregator/5541867?ref=vidal"><i class="fa fa-download"></i> <?php echo _text('MENU_DOWNLOAD'); ?></a></li> -->
                    <li>
    ...
    <footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    ...
                    <ul class="list-unstyled share-group clearfix">
                        <li><a href="<?php echo get_facebook_share_url();?>"><i class="fa fa-facebook fa-2x"></i></a></li>
                        <li><a href="<?php echo get_twitter_share_url();?>"><i class="fa fa-twitter fa-2x"></i></a></li>
                        <li><a href="<?php echo get_linkedin_share_url(); ?>"><i class="fa fa-linkedin fa-2x"></i></a></li>
                        <li><a href="<?php echo get_google_plus_share_url();?>"><i class="fa fa-google-plus fa-2x"></i></a></li>
                    </ul>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <p> &copy; 2015 <?php echo _text('POWERED_BY'); ?> <a class="newsearch" href="<?php echo $siteurl;?>"><?php echo $contact_company_name;?></a></p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <?php endif; ?>
    <script src="/assets/js/app.js" type="text/javascript" ></script><!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-53e3a28c0ff7435c" async="async"></script>
